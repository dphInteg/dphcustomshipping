...
namespace DphInteg\DPHCustomShipping\Helper;
 ...
 */
class CustomShippingData extends AbstractHelper
{
     ...
     */
     ...
     const XML_PATH_SHIPPING = 'carriers/dphcustomshipping';
     const XML_SHIPPING_CODE = 'dphcustomshipping';
