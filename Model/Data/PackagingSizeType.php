 ...
 */
namespace DphInteg\DPHCustomShipping\Model\Data;
...
class PackagingSizeType implements ArrayInterface
{
    ...
    public function selectedPartner() {
        if($this->scopeConfig->getValue('carriers/dphcustomshipping/partner', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)) {
            return $this->scopeConfig->getValue('carriers/dphcustomshipping/partner', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        } else {
